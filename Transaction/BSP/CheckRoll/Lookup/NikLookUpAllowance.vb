...
Public Class NIKLookUpAllowance
    ...
    Public Sub ShowForm(jobdesc As String)
        ...
        dt = CheckRoll_BOL.LookUpBOL.CRNikForAllowanceDeduction(txtNik.Text, txtName.Text, cmbMandorKrani.SelectedValue, "Active", DateTime.Now)
    ...
    Private Sub NIKLookUp_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            If Me.Parameter.Text = "NoTeam" Then
                ...
                DTNIKSelect = CheckRoll_BOL.LookUpBOL.CRNikForAllowanceDeduction(txtNik.Text, txtName.Text, "", "Active", AttDate)
        ...
        If JobsDesc IsNot Nothing Then
            ...
            If JobsDesc = "Mandor" Then
                ...
                DTNIKSelect = CheckRoll_BOL.LookUpBOL.CRNikForAllowanceDeduction(txtNik.Text, txtName.Text, cmbMandorKrani.SelectedValue, "Active", AttDate)
            Else
                If (JobsDesc <> "") Then
    ...
    Private Sub btnVehicleSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnVehicleSearch.Click
        If Parameter.Text = "NoTeam" Then
            Dim DTNIKSelect As DataTable = New DataTable
            'DTNIKSelect = CheckRoll_BOL.LookUpBOL.CRNikForAllowanceDeduction(txtNik.Text, txtName.Text, txtMandor.Text, "Active", AttDate)
