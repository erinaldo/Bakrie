...
Public Class BonusEmployeeReport

    Private Sub BonusEmployeeReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnProc_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnProc.Click
        ...
        dtEmployee = SalaryEmployee_DAL.GetBonusEmployee(StartDate.Value, EndDate.Value)
        For Each employee As DataRow In dtEmployee.Rows
            ...
            With gajiPokok
                ...
                .DedSPSI = employee("SPSI")
                .DedSPSB = employee("SPSB")
        ...
        Dim crReport As New CRBonusSlip
        ...
        txtMonthYear.Text = Me.txtTajuk.Text
