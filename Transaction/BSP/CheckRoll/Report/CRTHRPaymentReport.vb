...
Public Class CRTHRPaymentReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BSP.CRTHRPaymentReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRTHRPaymentReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRTHRPaymentReport = New CRTHRPaymentReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
