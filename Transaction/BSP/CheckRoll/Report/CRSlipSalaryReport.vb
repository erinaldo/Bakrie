...
Public Class CRSlipSalaryReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BSP.CRSlipSalaryReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRSlipSalaryReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRSlipSalaryReport = New CRSlipSalaryReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
