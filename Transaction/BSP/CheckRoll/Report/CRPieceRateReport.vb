...
Public Class CRPieceRateReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BSP.CRPieceRateReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPieceRateReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPieceRateReport = New CRPieceRateReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
