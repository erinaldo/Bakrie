...
Imports Vehicle_PPT
Imports Vehicle_BOL
Public Class DistribusiCheckrollReport
    ...
    Private Sub btnReport_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReport.Click
        Dim DistribusiViewReportReportFrm As New DistribusiViewReport
        Dim objDistribusiBiayaBengkelReportPPT As New DistribusiBiayaBengkelReportPPT
        Dim objDistribusiBiayaBengkelReportBOL As New DistribusiBiayaBengkelReportBOL
        ...
        DistribusiViewReport.Cursor = Cursors.WaitCursor
        DistribusiViewReport.Show()
        DistribusiViewReport.Cursor = Cursors.Arrow
    End Sub
End Class