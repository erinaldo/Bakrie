...
Public Class CRSalarySignature
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BSP.CRSalarySignature.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRSalarySignature
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRSalarySignature = New CRSalarySignature()
        rpt.Site = Me.Site
        Return rpt
    End Function
