...
#Region "Functions"
    ...
    Private Sub LoadVehicleCode()
        ...
        If (dt Is Nothing Or dt.Rows.Count = 0) And (txtVHNoSearch.Text <> String.Empty Or txtVehicleName.Text <> String.Empty Or cmbVHCategory.SelectedIndex > 0) Then
            txtVHNoSearch.Focus()
