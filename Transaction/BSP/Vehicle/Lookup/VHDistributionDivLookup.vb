...
Public Class VHDistributionDivLookup
    ...
    Sub SetUICulture(ByVal culture As String)
        ...
        Dim rm As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(VHDistributionDivLookup))
        Try
    ...
    Public Sub BindDIV(ByVal psSIVBlockID)
        Dim objDiv As New VehicleDistributionPPT
        ...
        ds = VehicleDistributionBOL.GetDIV(objDiv, "NO")
    ...
    Private Sub btnDIVSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDIVSearch.Click
        ...
        ''Dim objDivPPt As New VehicleDistributionPPT
        ''Dim ds As New DataSet
        ''objDivPPt.Div = txtDIVSearch.Text.Trim()
        ''objDivPPt.DivName = txtDivNameSearch.Text.Trim()
        ''ds = VehicleDistributionBOL.GetDIV(objDivPPt, "NO")
        ''If (ds.Tables(0).Rows.Count <= 0) Then
        ''    lblNoRecord.Visible = True
        ''    dgDIV.AutoGenerateColumns = False
        ''    dgDIV.DataSource = ds.Tables(0)
        ...
        'Dim objDiv As New VehicleDistributionPPT
        'Dim ds As New DataSet
        'ds = VehicleDistributionBOL.GetDIV(objDiv)
        'dgDIV.DataSource = ds.Tables(0)
    End Sub
