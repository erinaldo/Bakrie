...
Public Class VehicleRunningLogRpt
    ...
    Private Sub VehicleRunningLogRpt_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        tblAdt.Fill(ds, "VehicleRunningLogReport;1")
        'rpt = New IPRReport
        ...
        txtFiscal.Text = "Vehicle Running Proof List " & General.MonthYear(GlobalPPT.IntActiveMonth) & " " & GlobalPPT.intActiveYear.ToString() '& " <" & GlobalPPT.FiscalYearFromDate.Date.ToString("dd/MM/yyyy") & "," & GlobalPPT.FiscalYearToDate.Date.ToString("dd/MM/yyyy") & ">"
        ...
        crvVehicleRunningLogRpt.ParameterFieldInfo = ParamterFields

        rpt.SetDatabaseLogon(strServerUserName, strServerPassword)
        rpt.SetDataSource(ds)
        crvVehicleRunningLogRpt.ReportSource = rpt
