...
Public Class VehicleDistributionRpt
    ...
    Private Sub VehicleDistributionRpt_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        tblAdt.Fill(ds, "VehicleDistributionReport;1")
        'rpt = New IPRReport

        Dim txtFiscal, txtFromDate, txtToDate As CrystalDecisions.CrystalReports.Engine.TextObject
        ...
        txtFiscal.Text = "Vehicle Distribution Proof List " & General.MonthYear(GlobalPPT.IntActiveMonth) & " " & GlobalPPT.intActiveYear.ToString() '& " <" & GlobalPPT.FiscalYearFromDate.Date.ToString("dd/MM/yyyy") & "," & GlobalPPT.FiscalYearToDate.Date.ToString("dd/MM/yyyy") & ">"
        ...
        crvVehicleDistributionRpt.ParameterFieldInfo = ParamterFields
        ...
        crvVehicleDistributionRpt.ReportSource = rpt
