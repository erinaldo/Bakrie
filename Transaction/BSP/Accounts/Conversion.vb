            ...
            Select Case j
                Case 0, 3, 6, 9, 12
                    ...
                    Select Case j
                        Case 3
                            ' thousands
                            Dim pattern3 As String = mNumWord.Trim


                            If (pattern3.EndsWith("million")) Or (pattern3.EndsWith("trillion")) Or (pattern3.EndsWith("billion")) Then
                                '    '  mNumWord &= mNumWord & Delimiter
                                'ElseIf ("trillion" Like pattern3).ToString Then
                                'ElseIf ("billion" Like pattern3).ToString Then
                            Else
                        ...
                        Case 6
                            ' millions
                            Dim pattern3 As String = mNumWord.Trim
                            If (pattern3.EndsWith("trillion")) Or (pattern3.EndsWith("billion")) Then
                                '    '  mNumWord &= mNumWord & Delimiter
                                'ElseIf ("trillion" Like pattern3).ToString Then
                                'ElseIf ("billion" Like pattern3).ToString Then
                            Else
                        ...
                        Case 9
                            ...
                            ' millions
                            Dim pattern3 As String = mNumWord.Trim
                            If (pattern3.EndsWith("trillion")) Then
                                '    '  mNumWord &= mNumWord & Delimiter
                                'ElseIf ("trillion" Like pattern3).ToString Then
                                'ElseIf ("billion" Like pattern3).ToString Then
                            Else
