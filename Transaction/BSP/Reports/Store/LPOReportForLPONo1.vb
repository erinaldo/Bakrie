...
Public Class LPOReportForLPONo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BSP.LPOReportForLPONo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_LPONo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedLPOReportForLPONo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LPOReportForLPONo = New LPOReportForLPONo()
        rpt.Site = Me.Site
        Return rpt
    End Function
