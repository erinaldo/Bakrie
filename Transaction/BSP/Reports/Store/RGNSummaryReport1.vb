...
Public Class RGNSummaryReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BSP.RGNSummaryReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRGNSummaryReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RGNSummaryReport = New RGNSummaryReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
