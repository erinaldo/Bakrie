...
Public Class ISRReportForISRNo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BSP.ISRReportForISRNo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ISRNo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedISRReportForISRNo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ISRReportForISRNo = New ISRReportForISRNo()
        rpt.Site = Me.Site
        Return rpt
    End Function
