...
Public Class IDNSummaryReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BSP.IDNSummaryReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIDNSummaryReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IDNSummaryReport = New IDNSummaryReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
