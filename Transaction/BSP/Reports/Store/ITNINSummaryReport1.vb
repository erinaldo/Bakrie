...
Public Class ITNINSummaryReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BSP.ITNINSummaryReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedITNINSummaryReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ITNINSummaryReport = New ITNINSummaryReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
