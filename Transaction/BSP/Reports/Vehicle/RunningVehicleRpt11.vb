...
Public Class RunningVehicleRpt1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BSP.RunningVehicleRpt1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRunningVehicleRpt1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RunningVehicleRpt1 = New RunningVehicleRpt1()
        rpt.Site = Me.Site
        Return rpt
    End Function
