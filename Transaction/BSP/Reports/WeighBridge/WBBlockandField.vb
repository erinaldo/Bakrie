...
Public Class WBBlockandField
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BSP.WBBlockandField.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWBBlockandField
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WBBlockandField = New WBBlockandField()
        rpt.Site = Me.Site
        Return rpt
    End Function
