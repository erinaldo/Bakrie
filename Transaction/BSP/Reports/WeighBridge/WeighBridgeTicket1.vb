...
Public Class WeighBridgeTicket
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BSP.WeighBridgeTicket.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_WBTicketNo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedWeighBridgeTicket
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WeighBridgeTicket = New WeighBridgeTicket()
        rpt.Site = Me.Site
        Return rpt
    End Function
