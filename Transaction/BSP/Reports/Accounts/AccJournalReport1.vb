...
Public Class AccJournalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BSP.AccJournalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAccJournalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AccJournalReport = New AccJournalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
