...
Public Class StoreNonStockIPRReportView
    ...
    Private Sub StoreNonStockIPRReportView_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim rpt As New NonStockIPRReportForIPRNo
        ...
        cmd.CommandText = "Store.NONStockIPRReportForIPRNO '" & StoreNonStockIPRReportFrm.strSTIPRNo & "','" & GlobalPPT.strEstateID & "','" & GlobalPPT.strActMthYearID & "'"
        cmd.CommandType = CommandType.StoredProcedure
        tblAdt.SelectCommand = cmd
        tblAdt.Fill(ds, "NONStockIPRReportForIPRNO;1")
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            cmd1.Connection = con
            cmd1.CommandText = "Store.IPRReportForIPRNOREALISASI '" & StoreNonStockIPRReportFrm.strUsageCOAID & "','" & GlobalPPT.strEstateID & "','" & GlobalPPT.IntLoginMonth & "','" & GlobalPPT.intLoginYear & "'"
