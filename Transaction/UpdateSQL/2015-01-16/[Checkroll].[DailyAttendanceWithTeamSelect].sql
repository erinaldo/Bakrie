...
/****** Object:  StoredProcedure [Checkroll].[DailyAttendanceWithTeamSelect]    Script Date: 16/01/2015 9:03:17 ******/
	...
	IF @SaveUPDate = 'Save'
				...
				(
					...
					FROM
						...
						INNER JOIN Checkroll.GangEmployeeSetup AS C_GES on C_DTA.GangMasterID = C_GES.GangMasterID AND
