...
/****** Object:  StoredProcedure [Checkroll].[DailyTeamActivityEditTeam]    Script Date: 23/12/2014 16:02:31 ******/
SET ANSI_NULLS ON
GO
...
AS
BEGIN
	SELECT        Checkroll.DailyTeamActivity.Id, Checkroll.DailyTeamActivity.DDate, Checkroll.DailyTeamActivity.DailyTeamActivityID, Checkroll.DailyTeamActivity.GangMasterID, 
                         ...
                         Checkroll.GangMasterBesar.GangMasterBesarID, Checkroll.GangMaster.Category, Checkroll.GangMaster.Descp, Checkroll.GangEmployeeSetup.EmpID, 
...
FROM            Checkroll.CREmployee AS CREmployee_1 RIGHT OUTER JOIN
                         ...
                         Checkroll.GangEmployeeSetup LEFT OUTER JOIN
                         Checkroll.CREmployee AS CREmployee_2 ON Checkroll.GangEmployeeSetup.EmpID = CREmployee_2.EmpID ON 
                         Checkroll.DailyTeamActivity.GangMasterID = Checkroll.GangEmployeeSetup.GangMasterID LEFT OUTER JOIN
...
WHERE        (Checkroll.DailyTeamActivity.GangMasterID = @GangMasterID AND Checkroll.DailyTeamActivity.EstateID = @EstateID AND Checkroll.DailyTeamActivity.DailyTeamActivityID = @DailyTeamActivityID)
END
