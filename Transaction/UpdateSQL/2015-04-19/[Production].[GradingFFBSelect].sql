...
/****** Object:  StoredProcedure [Production].[GradingFFBSelect]    Script Date: 4/19/2015 3:30:38 PM ******/
...
AS   
		...
		SELECT        WB_WeighINOUT.WBTicketNo, P_GFFB.GradingID, P_GFFB.WeighingID, P_GFFB.GradingDate, P_GFFB.MinMaturity, P_GFFB.LosseFruitPerBunche, 
                         ...
                         P_GFFB.DamageComment, P_GFFB.DocumentNumber, P_GFFB.TotalGradedBunches, P_GFFB.Abnormal, P_GFFB.AbnormalComment, P_GFFB.RipeComment, 
                         P_GFFB.BunchStalkNotCutJ, P_GFFB.BunchStalkNotCutComment, P_GFFB.RottenBunchJ, P_GFFB.RottenBunchComment, P_GFFB.BuahRestan1to2J, 
                         P_GFFB.BuahRestan1to2Comment, P_GFFB.BinNumber
