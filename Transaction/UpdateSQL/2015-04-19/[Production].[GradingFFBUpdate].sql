...
/****** Object:  StoredProcedure [Production].[GradingFFBUpdate]    Script Date: 4/19/2015 3:30:53 PM ******/
...
BEGIN TRY
		...
		UPDATE Production.GradingFFB  SET 
		   ...
		   ,RipeComment=@RipeComment
			,BunchStalkNotCutJ=@BunchStalkNotCutJ
			,BunchStalkNotCutComment=@BunchStalkNotCutComment
			,RottenBunchJ=@RottenBunchJ
			,RottenBunchComment=@RottenBunchComment
			,BuahRestan1to2J=@BuahRestan1to2J
			,BuahRestan1to2Comment=@BuahRestan1to2Comment
			,BinNumber =@BinNumber
