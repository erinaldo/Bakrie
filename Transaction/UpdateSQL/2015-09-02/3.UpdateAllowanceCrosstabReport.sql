...
Alter PROCEDURE [Checkroll].[AllowanceCrosstabReport]
...
select EA.EmpId, CRE.EmpCode  + ' ' +  CRE.EmpName as EmpName, 
case EA.[Type]
	When 'A' then Amount
	when 'D' then Amount * -1  
end
	 as Amount, EA.[Type] as AllDedType, StartDate, EndDates, ad.AllowDedCode, ad.AllowDedCode + ' ' + AD.Remarks as Remarks from Checkroll.EmpAllowanceDeduction EA
