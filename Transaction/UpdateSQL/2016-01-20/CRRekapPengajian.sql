...
Alter PROCEDURE [Checkroll].[CRRekapPengajian]  
...
Select MonthlySalary.*, CS.GangMasterID, CRE.EmpCode,CRE.EmpName,Gm.GangName,CRE.Category,CRE.BankID,CRE.BankAccountNo from 
