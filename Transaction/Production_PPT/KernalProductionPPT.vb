Public Class KernalProductionPPT
...
#Region "Private Member Declarations"
    ...
    Private _StockKernalID As String = String.Empty
    ...
    Public Property Writeoff As Double = 0
    ...
    Private _KernelType As String = String.Empty
...
#Region "Public Member Declarations"
    ...
    Public Property StockKernalID() As String
        Get
            Return _StockKernalID
        End Get
        Set(ByVal value As String)
            _StockKernalID = value
        End Set
    End Property

    Public Property KernelType() As String
        Get
            Return _KernelType
        End Get
        Set(ByVal value As String)
    ...
    Public Property ProdLoadingID() As String
        ...
        End Set
    End Property
    Public Property KernalDate() As Date
        Get
            Return _KernalDate
        End Get
